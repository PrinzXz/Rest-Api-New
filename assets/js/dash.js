...
function getvisitors() {
	...
	var url = "https://api.countapi.xyz/hit/api.xyroinee.xyz/visitors";
	xhr.onloadend = function () {
		data = JSON.parse(this.responseText);
		document.getElementById("visitors").textContent = data.value;
	};
...
// User Login
$.getJSON("https://api.countapi.xyz/hit/api.xyroinee.xyz/userlogin", function(response) {
    $("#userlogin").text(response.value);
})

// Request Today
$.getJSON("https://api.countapi.xyz/hit/api.xyroinee.xyz/requesttoday", function(response) {
    $("#requesttoday").text(response.value);
})

// Total Request
$.getJSON("https://api.countapi.xyz/hit/api.xyroinee.xyz/totalrequest", function(response) {
...
// User Agent
txt = "";
txt += "<p><b>User agen</b>: <br>" + navigator.appVersion + "</p>";
